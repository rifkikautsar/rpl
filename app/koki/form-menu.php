...
<div class=" offset-lg-3 col-lg-6">    
    <div class="container">
        ...
        <div class="mb-3" col="12">
            ...
            <input type="text" class="form-control form-control-sm" name="harga-menu" autocomplete="off" required>
        </div>
        <div class="mb-3" col="12">
            <label for="inputStok" class="form-label">Stok</label>
            <input type="text" class="form-control form-control-sm" name="stok" autocomplete="off" required>
        </div>
        <div class="mb-3" col="12">
            <label for="inputKeterangan" class="form-label">Keterangan:</label>
            <textarea class="form-control form-control-sm" rows="3" name="keterangan" autocomplete="off" required></textarea>
        </div>
        <div class="mb-3" col="12">
