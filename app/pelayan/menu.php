                        ...
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td><select name="kd_meja" id="kd_meja" onchange="show()">
                                        <option value="<?php echo(isset($_POST['kd_meja'])?$_POST['kd_meja']:"");?>">
                            ...
                            <tr>
                                <td><button name="ok" value="ok" class="btn btn-success" style="width: 5em;">Ok</button>
                                </td>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="center" class="font-weight-bold text-primary">Rp.
                                                    <?=number_format($total,2,",",".");?></td>
                                            </tr>
                                            <?php }else{ ?>
                                            Yah belum ada pesanan. Pesan dulu ya dan masukkan jumlah pesanan, lalu klik
                                            simpan!
                                            <?php } ?>
                                        </table>
                                    </div>
